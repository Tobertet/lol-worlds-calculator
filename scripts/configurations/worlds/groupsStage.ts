...
const playInsLeagueSolver: BracketSolver = (scenario) => {
  ...
  const match2: Match = { seed1: 1, seed2: 2, result: getResult(scenario, 2) };
  const match3: Match = { seed1: 1, seed2: 3, result: getResult(scenario, 3) };
  const match4: Match = { seed1: 1, seed2: 3, result: getResult(scenario, 4) };
  const match5: Match = { seed1: 1, seed2: 4, result: getResult(scenario, 5) };
  const match6: Match = { seed1: 1, seed2: 4, result: getResult(scenario, 6) };
  const match7: Match = { seed1: 2, seed2: 3, result: getResult(scenario, 7) };
  const match8: Match = { seed1: 2, seed2: 3, result: getResult(scenario, 8) };
  const match9: Match = { seed1: 2, seed2: 4, result: getResult(scenario, 9) };
  const match10: Match = {
    seed1: 2,
    seed2: 4,
...
export const worldsMainConfiguration: ChampionshipConfiguration = {
  totalMatches: 12,
  totalTeams: 4,
